...
class DelayAnalyzer:
    ...
    def __init__(self, spark: SparkSession, data_path: str = "output/train_movements.parquet"):
        self.spark = spark
    ...
    def analyze_station_delay(self, station_name: str) -> float:
        ...
        logger.info("Daily Delay Statistics (not final result of average daily delay):")
    ...
    def run(self, station_name: str = "Berlin Hbf"):
        ...
        if avg_delay is not None:
            logger.info(f"Results for {station_name}:")
